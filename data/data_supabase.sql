...
-------------------- ÉTAPE 3 : Extraction et décodage depuis les CSV (Staging) --------------------
...
-- Import depuis la table staging_university_csv
...
-- Import depuis la table staging_mock_enrollments
